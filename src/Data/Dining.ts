import ConceptualizationandThemeSelection from "@Assets/Dining/Conceptualization and Theme Selection.jpg";
import SpacePlanningandLayoutDesign from "@Assets/Dining/Space Planning and Layout Design.jpg";
import MaterialandFurnitureSelection from "@Assets/Dining/Material and Furniture Selection.jpg";
import LightingandAmbianceEnhancement from "@Assets/Dining/Lighting and Ambiance Enhancement.jpg";
import CustomizationandPersonalization from "@Assets/Dining/Customization and Personalization.jpg";
import QualityAssuranceandFinalTouches from "@Assets/Dining/Quality Assurance and Final Touches.jpg";
import d1 from "@Assets/Dining/d1.jpg";
import d2 from "@Assets/Dining/d2.jpg";
import d3 from "@Assets/Dining/d3.jpg";
import d4 from "@Assets/Dining/d4.jpg";
import d5 from "@Assets/Dining/d5.jpg";
import d6 from "@Assets/Dining/d6.jpg";
import d7 from "@Assets/Dining/d7.jpg";
import d8 from "@Assets/Dining/d8.jpg";
...
export const DiningLightboxData = [
  {
    image: d1,
  },
  {
...
export const DiningAccordionData = [
  {
    question: "What dining experiences do you offer?",
    answer:
      "Our dining experiences range from intimate dinners to lavish banquets, catering to various occasions and culinary preferences. We curate bespoke menus and ambiance to create memorable dining moments for our guests.",
  },
  {
    question: "How do you ensure the quality of your menu selection?",
    answer:
      "We meticulously select ingredients from trusted suppliers and work closely with our culinary team to craft exquisite dishes that showcase creativity, flavor, and freshness. Our chefs prioritize seasonal ingredients and innovative cooking techniques to elevate your dining experience.",
  },
  {
    question: "Can I request customization for my dining experience?",
    answer:
      "Absolutely! We offer customizable dining packages tailored to your preferences, dietary restrictions, and event requirements. Whether you have specific menu preferences or need special arrangements, we're dedicated to accommodating your requests to ensure a memorable dining experience.",
  },
  {
    question: "What ambiance can I expect in your dining establishment?",
    answer:
      "Immerse yourself in an elegant dining ambiance characterized by sophisticated decor, ambient lighting, and impeccable service, setting the perfect stage for memorable dining moments.",
  },
  {
    question: "Do you provide private dining options?",
    answer:
      "Yes, we offer private dining options for intimate gatherings, celebrations, and corporate events. Our dedicated event planners work with you to customize every detail, from menu selection to decor, ensuring a personalized and memorable dining experience for you and your guests.",
  },
  {
    question: "How far in advance should I make a reservation?",
    answer:
      "We recommend making reservations in advance to secure your preferred dining experience, especially during peak hours or for special events. Contact our reservation team to inquire about availability and book your table to ensure a seamless dining experience.",
  },
];
